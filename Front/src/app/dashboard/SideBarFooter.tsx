  ...
  return (
    <main>
        ...
        <Link to={"/statistics"} className="size-[2rem] ">
          <img src="/icons/Activity 2.svg" alt="Statistics" className="object-cover hover:text-[#FCCF58] size-[2rem]" />
        </Link>
        </button>
        <button className='flex items-center justify-center md:h-[9.30rem] border-b-2 border-[#323131]'>
