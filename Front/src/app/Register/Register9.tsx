        ...
        <div className="flex mt-16">
          <Select>
            ...
            <SelectContent className=" ml-4">
              <SelectGroup className="bg-white pt-1">
                <SelectItem value="+54" className="hover:bg-yellow-700">
                  +54
                </SelectItem>
                <SelectItem value="+591" className="hover:bg-yellow-700">
                  +591
                </SelectItem>
                <SelectItem value="+55" className="hover:bg-yellow-700">
                  +55
                </SelectItem>
                <SelectItem value="+56" className="hover:bg-yellow-700">
                  +56
                </SelectItem>
                <SelectItem value="+57" className="hover:bg-yellow-700">
                  +57
                </SelectItem>
                <SelectItem value="+593" className="hover:bg-yellow-700">
                  +593
                </SelectItem>
                <SelectItem value="+595" className="hover:bg-yellow-700">
                  +595
                </SelectItem>
                <SelectItem value="+51" className="hover:bg-yellow-700">
                  +51
                </SelectItem>
                <SelectItem value="+598" className="hover:bg-yellow-700">
                  +598
                </SelectItem>
              </SelectGroup>
            </SelectContent>
          ...
          <div>
            <Input
              ...
              className="bg-transparent w-96 border-black rounded-md"
